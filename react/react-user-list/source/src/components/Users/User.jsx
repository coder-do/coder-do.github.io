...
export const User = ({ id, avatar, email, first_name, last_name, onInvite, isInvited }) => (
    <li>
        <div>
        ...
        <img onClick={() => onInvite(id)} className="action" src={`/assets/${!isInvited ? 'plus' : 'minus'}.svg`} alt="Action" />
    </li>
);
